...
```js
let userName = "Kader"; // data type inferred as string
```
...
- Array Type- similar data
  ...
  ```js
  // let users = ["Nishan", "Kader", "Nirob"];

  // let users: string[];
  // users = ["Nishan", "Kader", "Nirob"];
...
- object Type: can store value as key value pair
  ...
  user1 = { userName: "Nirob", userId: 101 };
  users.push(user1);

  let user2: { userName: string, userId: number };
  user2 = { userName: "Nishan", userId: 102 };
...
- custom Type: you can create your own type
  ...
  let user1: User;
  user1 = { userName: "Kader", userId: 101 };
  users.push(user1);
  ...
  let user3: User;
  user3 = { userName: "Nirob", userId: 103 };
  users.push(user3);
...
- Example
  ...
  let user1 = new User("Abdul Kader", 24);
  user1.display();

  let user2 = new User("Sanjida", 19);
  user2.display();
  ```
...
let student1 = new Student("Payel", 31, 1302020015);
student1.display();
...
let user1: User = { id: 1, name: "Mr. Tomato", age: 32 };
let user2: User = { id: 2, name: "Mr. Tomato", age: 21 };
...
````js
  ...
  interface UserFormatter {
    ...
    let user = new User("Mr. Tomato", 32);
    console.log(user);
...
const s1 = new Student("Abdul Kader", "1302020017");
...
- example
  ...
  userInfo1 = () => {
    console.log("Abdul Kader is 22 years old");
  };
  ...
  userInfo1();
  userInfo2("Abdul Kader");
  console.log(userInfo3("Abdul Kader"));
  ```
